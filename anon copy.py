...
def app_layout(app, process_df,sessions_left, all_attendance_df, sessions_per_m):
    # print("The real blinky")
    # print(sessions_per_m)
    ...
    for index, member_type in enumerate(low_attend_report['Member Type']):
        if "Package" in member_type:
            #low_attend_report['Member Type'][index] = member_type.split(" ")[0]
    ...
    # figgy=go.Figure(data=[go.Bar(x=['A','B','C','D'], y=[1,7,3,8], showlegend=False)])
    ...
    def create_modal_filter_row(id_number):#, filter_dict):
        ...
        #filter_dict[filter_name] = filter_row
    ...
    html.Div([
        ...
        # html.Div([html.Div(style={'height':'9px'}),
        ...
        html.Div([
            ...
            dbc.Modal([
                ...
                dbc.ModalBody(
                    ...
                    #html.Div(id = "dynamic-filter-container", children = [filter_row_0])#[filter_row_0])
                    ),
                dbc.ModalFooter(
                    html.Div([
                    html.Div([
                    ...
                    html.Div(style={'display':'inline-block', 'width':'20px'}),#,'width':'70%', 'verticalAlign': 'top'}),
                    html.Div([
                    dbc.Button("Run >>", id="close", n_clicks=0)
                    ],style={'display':'inline-block'})])#,style={'display':'inline-block','width':'15%', 'verticalAlign': 'top'})])
                ),
                    ],
                    id="modal",
                    size="lg",
...
# --------------------------------------------------------------------------------------------------------------
    ...
    html.Div([
        dcc.Dropdown(
            ...
            # {
            # "label":dcc.Link(children="Center Report" ,href='/center'),
            # "value":"Center Report"},
        ],
            value = 'Student Report',
...
def attend_scrape(sessions_left):
    ...
    for column in attendance.columns:
        ...
        if column in month_list:
            ...
            # print(attendance[column].sum())

    # print(attendance['Attendance Count'])
    # print("star")
    # print(attendance['Attendance Count'].mean())
    # print(attendance['Attendance Count'].shape)
    # print('abc')

    # count = 0
    # for bixby in attendance['Attendance Count']:
    #     count+=bixby
    ...
    # print(attendance['Attendance Count'])
    # print("START")
    # print(attendance['Full Name'])
    # print("START")
    # print(list(attendance['Full Name']))
    # print("START")
    # print(len(list(attendance['Full Name'])))
    # print("START")
    # print(set(list(attendance['Full Name'])))
    # print("START")
    # print(len(set(list(attendance['Full Name']))))
    # print("START")
